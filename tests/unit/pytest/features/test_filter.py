...
@pytest.fixture(
    scope='module',
    params=[{
        'spec': spec_file_u8_array_1,
        'data': data_file_u8_array,
    }])
def params_u8_array(request):
    return conftest.make_testcase(request.param)


def test_u8_array(params_u8_array):
    params = params_u8_array
    dtree = params['dtree']
...
@pytest.fixture(
    scope='module',
    params=[{
        'spec': spec_file_u8_array_2,
        'data': data_file_u8_array,
    }])
def params_u8_array_2(request):
    return conftest.make_testcase(request.param)


def test_u8_array_2(params_u8_array_2):
