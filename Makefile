...
SRC_LBITPUNCH = $(addprefix $(LBITPUNCH_SRCDIR)/,api/bitpunch_api.c core/ast.c core/expr.c core/browse.c core/interpreter.c core/print.c core/debug.c interpreters/item.c interpreters/integer.c interpreters/varint.c interpreters/string.c interpreters/base64.c interpreters/snappy.c interpreters/formatted_integer.c utils/dep_resolver.c utils/bloom.c utils/port.c)
