...
SRC_LBITPUNCH = $(addprefix $(LBITPUNCH_SRCDIR)/,api/bitpunch_api.c core/ast.c core/expr.c core/browse.c core/filter.c core/print.c core/debug.c filters/item.c filters/array.c filters/integer.c filters/varint.c filters/bytes.c filters/string.c filters/base64.c filters/snappy.c filters/formatted_integer.c utils/dep_resolver.c utils/bloom.c utils/port.c)
